...
namespace WPFByYourCommand.Commands
{
    ...
    public class WeakFunc<T1, T2, TResult>
    {
        ...
        public WeakFunc(Func<T1, T2, TResult> func, bool keepTargetAlive = false)
        ...
        public WeakFunc(object target, Func<T1, T2, TResult> func, bool keepTargetAlive = false)
        {
#if NETFX_CORE
...
#pragma warning restore CA1508 // Avoid dead conditional code
        ...
        public TResult Execute(T1 t1, T2 t2)
        {
            if (_staticFunc != null)
            {
                TResult result = _staticFunc(t1, t2);
                return result;
            }
